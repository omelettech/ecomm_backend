...
from users.views import GoogleSSOLoginView, CustomerView, WishlistView, WishlistItemView, WishlistDeleteView

urlpatterns = [
    path("v1/dj-rest-auth/", include("dj_rest_auth.urls")),
    path('v1/dj-rest-auth/registration/', include('dj_rest_auth.registration.urls')),
    path('v1/dj-rest-auth/google/', GoogleSSOLoginView.as_view(), name='google_login'),
